...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">angular-ngrx-signal-store documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            <li class="link">
                                <a href="interfaces/AddService.html" data-type="entity-link" >AddService</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/CountriesState.html" data-type="entity-link" >CountriesState</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="interfaces/GetByIdService.html" data-type="entity-link" >GetByIdService</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/GetService.html" data-type="entity-link" >GetService</a>
                            </li>
                            <li class="link">
